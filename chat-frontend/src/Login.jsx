...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    if (data.access_token) {
      ...
      setStatus("success");
      setTimeout(() => navigate("/roomlogin"), 1500);
    } else {
      setStatus("notoken");
      setLoading(false);
    }
  ...
  const statusMap = {
    error:   { cls: "error",   text: "✗ Login failed. Please check your credentials." },
    notoken: { cls: "error",   text: "✗ No access token found in response." },
    success: { cls: "success", text: "✓ Login successful. Redirecting..." },
  };
      ...
      <div className="left-panel">
        ...
        <div className="chat-scene">
          ...
          <div className="bubbles">
            <div className="bubble left">Welcome back! 👋</div>
            <div className="bubble right">Missed chatting with you ✨</div>
            <div className="bubble left">Login and let's catch up!</div>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                ...
                <input className="form-input" type="password" name="password" placeholder="Your password" required />
              </div>
            </div>
            ...
            {status && (
              <p className={`status-msg ${statusMap[status].cls}`}>
